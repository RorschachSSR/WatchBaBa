...
clear i h temp IStart ISuccess IStop IHint chapter level

%% Handle timeout in chapter 3
% TODO: Exit Flag in raw Data?


LvlTimer = readtable('leveltime.csv');
delta = LvlTimer.TimeSpent - T.Time2Win - T.Time4Revisit;

I = delta > 1 & T.Chapter == 3;
T.Time2Win(I) = LvlTimer.TimeSpent(I);

%% Savetable

writetable(T, 'leveltime_split.csv');